...
public abstract class PaperMessage extends UiDialog
{
    ...
    public void display(int x, int y)
    {
        ...
        gameDisplay.drawShadowText(headline, colorUi, x + (width - headlineWidth) / 2, y + height - 90, 0.5); // 0.8);

        GL11.glEnable(GL11.GL_SCISSOR_TEST);
        GL11.glScissor(x+40, y+110, width-80, height-200);

        gameDisplay.drawBoxedShadowText(message, colorText, x+40, y+height - 128 + messageYOffset, width - 80, linespace, 0.25); // 0.6);
